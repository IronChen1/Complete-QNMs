...
% s2n0l2m1_Kerr represents the QNM dataset of Kerr, with overtone = 0, ell = 2, and m = 1.
% s2n0l2mf1_Kerr represents the QNM dataset of Kerr, with overtone = 0, ell = 2, and m = -1.
